function openCity(evt, cityName) {
    ...
    tabcontent = document.getElementsByClassName("tabcowwntent");
...
(function ($, window, i) {
  $.fn.responsiveSlides = function (options) {
    ...
    var settings = $.extend({
      ...
      "manualControls": "slider3",     // Selector: Declare custom pager navigation
...
//   event.preventDefault();
//   $('.ottawa_update').show();
//   $('body').animate({scrollTop:$('.ottawa').offset().top},900)
// }, false);
// });
//
//
//
// document.querySelector(".hide_ottawa").addEventListener("click", function(event){
// event.preventDefault();
// $('.ottawa_update').none();
